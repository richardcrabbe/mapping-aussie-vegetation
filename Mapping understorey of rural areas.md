...
The aim of this study is to Sentinel-1, Sentinel-2 data and Random Forest algorithm in the Google Earth Engine to differentiate grassland types in lowland ACT to support the ACT Native Grassland Conservation Strategy and Action Plans for efficient management of the Natural Temperate Grasslands. To achieve this aim, the following specific objectives were addressed: <br> 
